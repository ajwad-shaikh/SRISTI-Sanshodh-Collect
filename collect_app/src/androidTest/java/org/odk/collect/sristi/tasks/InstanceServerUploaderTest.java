...
import org.odk.collect.sristi.dto.Instance;
import org.odk.collect.sristi.provider.InstanceProviderAPI;
import org.odk.collect.sristi.tasks.InstanceUploader.Outcome;
import org.odk.collect.sristi.test.MockedServerTest;

import okhttp3.mockwebserver.RecordedRequest;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNull;
import static org.odk.collect.sristi.test.TestUtils.assertMatches;
import static org.odk.collect.sristi.test.TestUtils.cleanUpTempFiles;
import static org.odk.collect.sristi.test.TestUtils.createTempFile;
import static org.odk.collect.sristi.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("Dalvik/.* org.odk.collect.sristi/.*", r.getHeader("User-Agent"));
