...
import org.odk.collect.sristi.adapters.IconMenuListAdapter;
import org.odk.collect.sristi.adapters.model.IconMenuItem;
import org.odk.collect.sristi.application.Collect;
import org.odk.collect.sristi.dao.FormsDao;
import org.odk.collect.sristi.dao.helpers.ContentResolverHelper;
import org.odk.collect.sristi.dao.helpers.FormsDaoHelper;
import org.odk.collect.sristi.dao.helpers.InstancesDaoHelper;
import org.odk.collect.sristi.exception.GDriveConnectionException;
import org.odk.collect.sristi.exception.JavaRosaException;
import org.odk.collect.sristi.external.ExternalDataManager;
import org.odk.collect.sristi.fragments.dialogs.CustomDatePickerDialog;
import org.odk.collect.sristi.fragments.dialogs.NumberPickerDialog;
import org.odk.collect.sristi.listeners.AdvanceToNextListener;
import org.odk.collect.sristi.listeners.FormLoaderListener;
import org.odk.collect.sristi.listeners.FormSavedListener;
import org.odk.collect.sristi.listeners.PermissionListener;
import org.odk.collect.sristi.listeners.SavePointListener;
import org.odk.collect.sristi.logic.FormController;
import org.odk.collect.sristi.logic.FormController.FailedConstraint;
import org.odk.collect.sristi.logic.FormInfo;
import org.odk.collect.sristi.preferences.AdminKeys;
import org.odk.collect.sristi.preferences.AdminSharedPreferences;
import org.odk.collect.sristi.preferences.GeneralSharedPreferences;
import org.odk.collect.sristi.preferences.PreferenceKeys;
import org.odk.collect.sristi.preferences.PreferencesActivity;
import org.odk.collect.sristi.provider.FormsProviderAPI.FormsColumns;
import org.odk.collect.sristi.provider.InstanceProviderAPI.InstanceColumns;
import org.odk.collect.sristi.tasks.FormLoaderTask;
import org.odk.collect.sristi.tasks.SaveFormIndexTask;
import org.odk.collect.sristi.tasks.SavePointTask;
import org.odk.collect.sristi.tasks.SaveResult;
import org.odk.collect.sristi.tasks.SaveToDiskTask;
import org.odk.collect.sristi.utilities.ActivityAvailability;
import org.odk.collect.sristi.utilities.ApplicationConstants;
import org.odk.collect.sristi.utilities.DependencyProvider;
import org.odk.collect.sristi.utilities.DialogUtils;
import org.odk.collect.sristi.utilities.FileUtils;
import org.odk.collect.sristi.utilities.ImageConverter;
import org.odk.collect.sristi.utilities.MediaManager;
import org.odk.collect.sristi.utilities.MediaUtils;
import org.odk.collect.sristi.utilities.SoftKeyboardUtils;
import org.odk.collect.sristi.utilities.TimerLogger;
import org.odk.collect.sristi.utilities.ToastUtils;
import org.odk.collect.sristi.views.ODKView;
import org.odk.collect.sristi.widgets.DateTimeWidget;
import org.odk.collect.sristi.widgets.QuestionWidget;
import org.odk.collect.sristi.widgets.RangeWidget;
import org.odk.collect.sristi.widgets.StringWidget;
...
import static org.odk.collect.sristi.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.odk.collect.sristi.utilities.ApplicationConstants.RequestCodes;
import static org.odk.collect.sristi.utilities.PermissionUtils.checkIfStoragePermissionsGranted;
import static org.odk.collect.sristi.utilities.PermissionUtils.finishAllActivities;
import static org.odk.collect.sristi.utilities.PermissionUtils.requestStoragePermissions;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    private void sendSavedBroadcast() {
        sendBroadcast(new Intent("org.odk.collect.sristi.FormSaved"));
    }
